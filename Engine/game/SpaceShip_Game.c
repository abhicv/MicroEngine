...
//NOTE(abhicv) : assets used in the game => https://ansimuz.itch.io/spaceship-shooter-environment
...
{   
    ...
    for (i = 0; i < 50; i++)
    {
        ...
        //NOTE(abhicv): reset bullet if gone out of bound or view
        ...
        //NOTE(abhicv): follow space ship if bullet in idle
        if (velocity[i] == 0.0f)
        {
            bullets[i]->position = spaceship->position;
        }
